...
func (b *NetworkBuilder) Build(c *fi.ModelBuilderContext) error {
	...
	if networking == nil || networking.Classic != nil {
		...
		assetNames = append(assetNames, "cni-ipvlan-vpc-k8s-ipam", "cni-ipvlan-vpc-k8s-ipvlan", "cni-ipvlan-vpc-k8s-tool", "cni-ipvlan-vpc-k8s-unnumbered-ptp", "ipvlan", "loopback")
	} else {
